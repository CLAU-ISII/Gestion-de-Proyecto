             ...
             <div class="row">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-warning text-white mb-4">
                        ...
                        <a href="tablero.php" class="btn btn-primary, card-body,small text-white stretched-link" >Tablero</a>
                          ...
                          <div class="card card-body">
                            <form action="save_task5.php" method="POST">
                              <div class="form-group">
                                <input type="text" name="usuario" class="form-control" placeholder="Ingrese usuario" autofocus autocomplete="off">
                            </div>
                            <div class="form-group">
                                <textarea name="password" rows="2" class="form-control" placeholder="Password"></textarea>
                            </div>
                            <div class="form-group">
                                <textarea name="login" rows="2" class="form-control" placeholder="login"></textarea>
                            </div>
                            <div class="form-group">
                                <textarea name="tipo_usuario" rows="2" class="form-control" placeholder="tipo_usuario"></textarea>
                            </div>
